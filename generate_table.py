...
def generate_table(fn):
    ...
    print("### Datasets")
    print("| name | size | read_more | description | license |")
    print("|------|------|-----------|-------------|---------|")
    for name, other in datasets:
        ...
        print("| {name} | {size} | {links} | {description} | {license} |".format(
            ...
            size="{} MB".format(other["size"] // 2 ** 20), license=other["license"]
        ))

    print("")
    print("### Models")
    print("| name | type | num vectors | size | base dataset | read_more  | description | parameters | preprocessing | license |")
    print("|------|------|-------------|------|--------------|------------|-------------|------------|---------------|---------|")
    for name, other in models:
        ...
        print("| {name} | {type} | {num_vectors} | {size} | {base_dataset} | {links} | {description} | {parameters} | {preprocessing} | {license} |".format(
            name=name, type=other["type"], num_vectors=other["num_vectors"],
            size="{} MB".format(other["size"] // 2 ** 20), base_dataset=other["base_dataset"],
            links=links, description=other["description"], parameters=parameters,
